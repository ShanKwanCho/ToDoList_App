...
export class CategoryComponent implements OnInit {
  ...
  '#928779', '#D4D2A5', '#FCDEBE', '#90A583', '#B26E63', '#C6CAED'];

  categories: Array<object>;

  categoryName : string = '';  // assigned empty string for global variable 
  ...
  onSubmit(fo:NgForm){
    ...
    if(this.dataStatus == 'Add'){
      ...
      let todoCategory = {
        category: fo.value.categoryName,
      ...
      fo.resetForm();
        ...
        this.categoryService.updateCategory(this.catId, fo.value.categoryName);
        fo.resetForm();
        this.dataStatus = 'Add';
    }
